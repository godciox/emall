...
(
    ...
    `mobile`              varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机' unique,
    ...
    `login_failure_count` int(11) DEFAULT 0 NOT NULL COMMENT '连续登录失败次数',
