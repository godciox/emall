...
func main() {
	...
	// Register handler
	if err := pb.RegisterInventoryServiceHandler(srv.Server(), new(handler.InventoryService)); err != nil {
		logger.Fatal(err)
	}
